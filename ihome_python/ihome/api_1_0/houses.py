...
def get_house_index():
    ...
    if ret:
        ...
        # return jsonify(errno=.., errmsg=.., data=houses_list)
        # {"errno": 0, "errmsg": "OK", "data": json_houses}, 200, {"Content-Type": "application/json"}
